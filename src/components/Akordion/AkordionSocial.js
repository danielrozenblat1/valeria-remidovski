...
export default function BasicAccordion() {
  ...
  return (
    ...
    <div className={styles.title} id="שאלות נפוצות" itemProp="mainEntity" itemScope itemType="https://schema.org/WebPage">שאלות נפוצות</div>
      <DropdownAccordion title="איך את יודעת איך לרשום את המלל בעמוד מבחינת המקצועיות של העסק?" content="ברור ! , לאורך דף הנחיתה אתה מנרטל התנגדויות שיכולות להיות לליד שלך בשיחת המכירה , גורם לו להבין מי אתה ושאתה זו שיכול לפתור לו את הבעיה , הוא מגיע לשיחה כשהוא מכיר אותך , את תהליך העבודה איתך והרבה יותר מוכן לסגור איתך - מה שמקצר את שיחת המכירה שלך  " />
      <DropdownAccordion title="מה אני מקבל חוץ מניהול העמודים שלי בסושיאל מדיה?" content="דף נחיתה הוא העובד הוירטואלי של כל בעל עסק ,הוא כלי עסקי לכל דבר ועניין שאוסף את כל אלה שמגיעים מהשיווק שלך ומעביר אותם תהליך חימום וסינון , הוא מסביר להם איזו בעיה אתה פותר , מי אתה , למה לבחור דווקא בך ועל התהליך שהם יעברו איתך. בדף יהיה מקום להשארת פרטים. ובמידה ובונה הדף שלך עשה עבודה טובה ,הפניות אליך יהיו הרבה יותר ממוקדות ורציניות  " />
      <DropdownAccordion title="אני צריך להתחייב לכמות זמן מסויימת ברגע שהלכנו על זה?" content="עוד לפני תהליך העבודה איתך , את/ה תקבל/י טופס שדרכו אני אצליח להבין את העסק שלך , לנתח את קהל היעד שלך ולפי עקרונות פסיכולוגיה צרכנית לדעת בדיוק מה לכתוב כדי להשפיע עליהם , אנחנו נפגשים לאחר שאני מגיע עם המון רעיונות ודרך שאלות מכוונות שלי אני מוציא ממך את המלל הכי ממוקד שחייב להיות בדף שלך" />
